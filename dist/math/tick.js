...
exports.getTickAtSqrtPrice = exports.getSqrtPriceAtTick = exports.SQRT_RATIO_MAX = exports.SQRT_RATIO_MIN = exports.TICK_MAX = exports.TICK_MIN = void 0;
const evm_js_1 = require("./evm.js");
const errors_js_1 = require("../utils/errors.js");
exports.TICK_MIN = -887272;
exports.TICK_MAX = 887272;
exports.SQRT_RATIO_MIN = 4295128739n;
exports.SQRT_RATIO_MAX = 1461446703485210103287273052203988822378723970342n;
/**
...
function getSqrtPriceAtTick(tick) {
    if (tick < exports.TICK_MIN || tick > exports.TICK_MAX) {
        throw new errors_js_1.MathError("tick is outside the range");
    }
    ...
    if (tick > 0) {
        ratio = evm_js_1.UINT256_MAX / ratio;
    }
    return (0, evm_js_1.uint160)((ratio >> 32n) + (ratio % (1n << 32n) === 0n ? 0n : 1n));
}
exports.getSqrtPriceAtTick = getSqrtPriceAtTick;
/**
 ...
 * @returns Tick
 */
function getTickAtSqrtPrice(sqrtPrice) {
    if (sqrtPrice < exports.SQRT_RATIO_MIN || sqrtPrice >= exports.SQRT_RATIO_MAX) {
        throw new errors_js_1.MathError("sqrt ratio is outside the range");
    }
    ...
    const tickLo = (logSqrt10001 - 3402992956809132418596140100660247210n) >> 128n;
    const tickHi = (logSqrt10001 + 291339464771989622907027621153398088495n) >> 128n;
    const tick = tickLo === tickHi || getSqrtPriceAtTick(Number(tickHi)) > sqrtPrice
        ? tickLo
        : tickHi;
    return Number(tick);
}
exports.getTickAtSqrtPrice = getTickAtSqrtPrice;
